...
public class v4withdummys extends Application {
    ...
    //dummylist
    ArrayList<CrewmateRacer> dummyList = null;
    ...
    public void initializeScene() {
        ...
        //add dummyList 
        dummyList = new ArrayList<CrewmateRacer>();
        CrewmateRacer dummy1 = new CrewmateRacer(false);
        CrewmateRacer dummy2 = new CrewmateRacer(false);
        CrewmateRacer dummy3 = new CrewmateRacer(false);
        CrewmateRacer dummy4 = new CrewmateRacer(false);
        ...
        for (CrewmateRacer dummy : dummyList) {
            this.root.getChildren().add(dummy);
            
        }
        this.root.getChildren().add(movableTop);
        ...
        public void update() {
            ...
            if (isMaster) {
                ...
                for (CrewmateRacer dummy : dummyList) {
                    ...
                    counter++;
                    model.setX(Math.random()*movableRGB.getWidth());
                    model.setY(Math.random()*movableRGB.getHeight());
